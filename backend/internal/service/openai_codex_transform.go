...
var openAICodexOAuthUnsupportedFields = append([]string{
	...
	"frequency_penalty",
	"presence_penalty",
	// Defense-in-depth against hybrid Chat Completions payloads (e.g. Cursor)
	// that may attach Responses-API-incompatible fields when the OAuth path
	// reaches this transform.
	"logprobs",
	"top_logprobs",
	"n",
	"seed",
