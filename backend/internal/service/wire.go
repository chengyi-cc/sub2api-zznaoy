...
func ProvideCandyMonitorService(repo CandyMonitorRepository, accounts AccountRepository, tester *AccountTestService) *CandyMonitorService {
	svc := NewCandyMonitorService(repo, accounts, tester)
	svc.Start()
	return svc
}
