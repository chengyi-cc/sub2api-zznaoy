...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/turn-state/settings", h.Admin.Account.GetTurnStateSettings)
		accounts.PUT("/turn-state/settings", h.Admin.Account.SaveTurnStateSettings)
		accounts.PUT("/ollama-cloud-usage/settings", h.Admin.Account.UpdateOllamaCloudUsageSettings)
		accounts.GET("/:id", h.Admin.Account.GetByID)
		accounts.GET("/:id/turn-state", h.Admin.Account.GetTurnStateAutoStatus)
		accounts.POST("/:id/turn-state/acquire", h.Admin.Account.TriggerTurnStateAcquisition)
...
func registerInvoiceAdminRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	invoice := admin.Group("/invoice")
	{
		...
		invoice.POST("/requests/batch-approve", h.Admin.Invoice.BatchApprove)
