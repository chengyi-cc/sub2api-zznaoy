...
func RegisterGatewayRoutes(
	...
	gateway.Use(requireGroupAnthropic)
	{
		...
		// Chat Completions 兼容层：按模型自动路由到 OpenAI Responses 或 Claude Messages handler。
		gateway.POST("/chat/completions", handler.ChatCompletionsRouter(h.OpenAIGateway, h.Gateway))
	}
