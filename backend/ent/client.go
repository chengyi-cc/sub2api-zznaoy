...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.IdentityAdoptionDecision, c.InvoiceRequest, c.PaymentAuditLog, c.PaymentOrder,
...
type (
	hooks struct {
		...
		PendingAuthSession, PromoCode, PromoCodeUsage, Proxy, RedeemCode, SecuritySecret,
