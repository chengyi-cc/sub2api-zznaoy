export default {
  ...
  invoice: {
    title: 'My Invoices',
    description: 'Submit invoice requests for completed orders',
    adminTitle: 'Invoice Management',
    adminDescription: 'Review user invoice requests, issue and upload invoice PDFs',
    adminUserId: 'User ID',
    adminSearchPlaceholder: 'Title / tax no / email / invoice no',
    ...
    taxNo: 'Tax No.',
    taxNoPlaceholder: 'Unified social credit code',
    recipientEmail: 'Recipient email (optional)',
    recipientEmailPlaceholder: 'Defaults to your registered email if empty',
    recipientEmailHint: 'Review results and issued notifications will be sent here; empty = your registered email',
    remark: 'Remark',
    ...
    sourceOrders: 'Orders (recharge)',
    sourceRedeemCodes: 'Redeem codes (balance)',
    noEligible: 'No eligible orders to invoice',
    noEligibleOrders: 'No eligible orders',
    noEligibleRedeemCodes: 'No eligible balance redeem codes',
    redeemCodes: 'redeem codes',
    rejectReason: 'Reject reason',
    rejectReasonPlaceholder: 'Explain why this request is rejected',
    rejectTitle: 'Reject invoice request',
    rejectConfirm: 'Reject request #{id}?',
    invoiceNo: 'Invoice No.',
    invoiceNoPlaceholder: 'Enter the actual issued invoice number',
    issueTitle: 'Issue invoice',
    issueTargetInfo: 'Issue invoice for request #{id} (¥{amount})',
    uploadPdf: 'Upload PDF',
    uploadPdfHint: 'PDF only, max 10MB; invoice number is auto-filled from the file name and can be edited',
    copyInfo: 'Copy info',
    copyInfoHint: 'Copies "Title / Tax No / Amount" as 3 cells, ready to paste into Excel',
    copySuccess: 'Copied ✓',
    exportApproved: 'Export approved (2 files)',
    exporting: 'Exporting…',
    exportEmpty: 'No approved invoice requests pending issue',
    exportFailed: 'Export failed, please retry',
    exportSheetName: 'Pending Issue',
    exportFilePrefix: 'approved_pending_issue',
    exportInvoiceListFilePrefix: 'invoice_issue_list',
    exportColSeq: 'No.',
    exportColTitle: 'Company / Personal Title',
    exportColTaxNo: 'Tax ID',
    exportColAmount: 'Amount',
    exportColUserEmail: 'User Email',
    exportColRecipientEmail: 'Recipient Email',
    userEmailCol: 'User Email',
    sourceCountCol: 'Sources',
    selectedCount: '{n} selected',
    batchApprove: 'Batch approve ({n})',
    batchApproveDone: '{ok} approved',
    batchApprovePartial: '{ok} approved, {fail} failed',
    batchUpload: 'Batch upload PDF',
    batchUploadHint: 'Matches current page only: auto-matched by "amount + company" in the file name, confirm issue per row. For multiple pages, upload in batches per page',
    batchUploadSummary: '{matched} matched, {unmatched} unmatched',
    chooseFile: 'Choose PDF',
    amountMismatchTag: 'File amount ¥{parsed} mismatch',
    amountMismatchConfirm: 'File name amount ¥{parsed} differs from request amount ¥{amount}. Issue anyway?',
    ...
    detailHeaderSection: 'Invoice Info',
    detailAmountTitle: 'Amount Reconciliation',
    detailRequestAmount: 'Requested',
    detailComputedSum: 'Computed',
    detailAmountMatch: 'Match ✓',
    detailAmountMismatch: 'Mismatch ✗',
    detailEligibilityWarning: '⚠ Some orders or redeem codes are no longer eligible; issuing will be rejected by backend',
    detailOwnershipMismatch: 'redeem code no longer owned by applicant',
    detailUserOverview: 'User Reconciliation',
    detailExceedsRecharge: 'Issued + In-flight > total recharged (possible over-invoicing)',
    userTotalRecharged: 'Total recharged',
    userBalance: 'Current balance',
    userIssuedTotal: 'Issued total',
    userInFlightTotal: 'In-flight (pending/approved)',
    userIssuedPlusInFlight: 'Issued + in-flight / total recharged',
