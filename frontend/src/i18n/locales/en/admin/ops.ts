export default {
    ops: {
      ...
      errorDetail: {
        ...
        archiveTruncated: 'The request body was not fully captured and cannot be fully replayed.',
        archiveMemoryLimited: 'The capture memory budget was reached. The body may be missing or incomplete; available error metadata is retained.',
        archiveCapacityExhausted: 'No sample was created: capture slots were full at the time. This does not mean the disk was full. The body cannot be downloaded or recovered.',
