export default {
    ops: {
      ...
      errorDetail: {
        ...
        archiveTruncated: '请求正文未完整采集，样本已截断，不能直接完整重放。',
        archiveMemoryLimited: '采集内存达到上限，正文可能缺失或不完整；仍保留已获取的错误信息。',
        archiveCapacityExhausted: '这条请求未生成诊断样本：当时采样名额已满，不表示磁盘已满，无法下载或补回正文。',
