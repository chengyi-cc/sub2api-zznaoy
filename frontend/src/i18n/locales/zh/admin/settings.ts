    ...
    settings: {
      ...
      features: {
        ...
        invoice: {
          ...
          enabled: '启用发票申请',
          enabledHint: '关闭后用户端“发票管理”入口隐藏并停止受理用户请求；管理员仍可查看和处理已有申请。',
          minAmount: '单次开票最低金额',
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentPlaceholder: 'codex-tui/0.153.4 (Mac OS 26.5.0; arm64) iTerm.app/3.6.10 (codex-tui; 0.153.4)',
