export default {
  ...
  admin: {
    ...
    settings: {
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加自定义 iframe 页面到侧边栏或顶部导航。每个页面可以设置为普通用户或管理员可见。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
  ...
  invoice: {
    title: '我的发票',
    description: '基于已完成订单提交开票申请',
    adminTitle: '发票管理',
    adminDescription: '审核用户开票申请，开具并上传发票 PDF',
    adminUserId: '用户 ID',
    adminSearchPlaceholder: '抬头 / 税号 / 邮箱 / 发票号',
    newRequest: '申请开票',
    submitRequest: '提交申请',
    allStatus: '全部状态',
    status: {
    ...
    taxNo: '税号',
    taxNoPlaceholder: '统一社会信用代码',
    recipientEmail: '接收邮箱（可选）',
    recipientEmailPlaceholder: '如不填写，将发送到您的注册邮箱',
    recipientEmailHint: '审核结果与开票完成通知会发送到此邮箱；留空使用注册邮箱',
    remark: '备注',
    ...
    sourceOrders: '订单（充值）',
    sourceRedeemCodes: '兑换码（余额）',
    noEligible: '当前没有可开票的订单',
    noEligibleOrders: '没有可开票的订单',
    noEligibleRedeemCodes: '没有可开票的余额兑换码',
    redeemCodes: '个兑换码',
    rejectReason: '驳回原因',
    rejectReasonPlaceholder: '请说明驳回的具体原因',
    rejectTitle: '驳回开票申请',
    rejectConfirm: '确认驳回申请 #{id}？',
    invoiceNo: '发票号',
    invoiceNoPlaceholder: '请输入实际开具的发票号',
    issueTitle: '开具发票',
    issueTargetInfo: '为申请 #{id}（¥{amount}）开具发票',
    uploadPdf: '上传发票 PDF',
    uploadPdfHint: '仅支持 PDF 格式，最大 10MB；上传后自动用文件名填入发票号，可手动修改',
    copyInfo: '复制信息',
    copyInfoHint: '复制为「抬头 / 识别号 / 金额」三格，可直接粘贴到 Excel',
    copySuccess: '已复制 ✓',
    exportApproved: '导出已通过待开票',
    exporting: '导出中…',
    exportEmpty: '当前没有「已通过待开票」的发票申请',
    exportFailed: '导出失败，请重试',
    exportSheetName: '已通过待开票',
    exportFilePrefix: '已通过待开票',
    exportColSeq: '序号',
    exportColTitle: '公司名称/个人抬头',
    exportColTaxNo: '纳税人识别号',
    exportColAmount: '金额',
    exportColUserEmail: '用户邮箱',
    exportColRecipientEmail: '接收邮箱',
    userEmailCol: '用户邮箱',
    sourceCountCol: '来源数',
    selectedCount: '已选 {n} 项',
    batchApprove: '批量通过（{n}）',
    batchApproveDone: '已通过 {ok} 项',
    batchApprovePartial: '通过 {ok} 项，失败 {fail} 项',
    batchUpload: '批量上传 PDF',
    batchUploadHint: '仅匹配当前页的待开票行：按文件名「金额+公司」自动匹配，再逐行确认开具。多页请翻页后分批上传',
    batchUploadSummary: '已匹配 {matched} 个，未匹配 {unmatched} 个',
    chooseFile: '选择 PDF',
    amountMismatchTag: '文件金额 ¥{parsed} 不符',
    amountMismatchConfirm: '文件名金额 ¥{parsed} 与申请金额 ¥{amount} 不一致，仍要开具吗？',
    ...
    detailTitle: '发票申请详情',
    detailApplicant: '申请人',
    detailHeaderSection: '发票信息',
    detailAmountTitle: '金额对账',
    detailRequestAmount: '申请金额',
    detailComputedSum: '当前合计',
    detailAmountMatch: '金额一致 ✓',
    detailAmountMismatch: '金额不一致 ✗',
    detailEligibilityWarning: '⚠ 有订单或兑换码状态已变更，开票时将被后端拒绝',
    detailOwnershipMismatch: '兑换码已不在申请人名下',
    detailUserOverview: '用户对账概览',
    detailExceedsRecharge: '已开+在途 > 总充值，疑似超开',
    userTotalRecharged: '总充值金额',
    userBalance: '当前余额',
    userIssuedTotal: '已开票合计',
    userInFlightTotal: '在途（待审/已通过）',
    userIssuedPlusInFlight: '已开 + 在途 / 总充值',
    confirmReject: '确认驳回',
    confirmIssue: '确认开具',
    approve: '通过',
    reject: '驳回',
